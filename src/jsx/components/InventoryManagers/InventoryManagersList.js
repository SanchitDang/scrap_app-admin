        ...
        <>
            ...
            <Modal className="fade" show={showModal} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>{isDisabled ? 'Enable' : 'Disable'} Inventory Manager</Modal.Title>
                </Modal.Header>
                <Modal.Body>Are you sure you want to {isDisabled ? 'Enable' : 'Disable'} this inventory manager?</Modal.Body>
                <Modal.Footer>
