  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const selectedProducts = amount_paid_each_product.map(
          (productDetail) => productDetail.product
        );
        const productDetails = amount_paid_each_product.map(
          (productDetail) => ({
          ...
          <div className="card-body">
            ...
            <form onSubmit={handleSubmit}>
              <div className="row mb-4">
                <div className="col-xl-4">
                  <div className="form-group mb-3 invoice">
                    ...
                    <Dropdown>
                      ...
                      >
                        {user_id._id
                          ? users.find((user) => user._id === user_id._id)?.name
                          : "Select User"}
                      </Dropdown.Toggle>
                      <Dropdown.Menu>
                        {users.map((user) => (
                ...
                <div className="col-xl-4">
                  <div className="form-group mb-3 invoice">
                    ...
                    <Dropdown>
                      ...
                      >
                        {agent_id
                          ? agents.find((agent) => agent._id === agent_id._id)
                              ?.name
                          : "Select Agent"}
                      </Dropdown.Toggle>
                      <Dropdown.Menu>
                ...
                {type==="waste-collection" ? <div className="row">
