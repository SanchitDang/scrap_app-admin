...
const DropdownBlog = ({ userId, onDelete, isDisabled }) => {
    ...
    const handleEdit = () => {
        history.push(`/edit-category/${userId}`);
    };
        ...
        <>
            ...
            <Modal className="fade" show={showModal} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>{isDisabled ? 'Enable' : 'Disable'} Category</Modal.Title>
                </Modal.Header>
                <Modal.Body>Are you sure you want to {isDisabled ? 'Enable' : 'Disable'} this category?</Modal.Body>
                <Modal.Footer>
        ...
        <>
            <div className="d-flex mb-3">
                <div className="mb-3 align-items-center me-auto">
                    <h4 className="fs-24 font-w800">Categories</h4>
                    <span className="fs-12">List of all the categories</span>
                </div>
                <li className="nav-item invoices-btn">
                    <Link to="/create-category" className="btn btn-primary ms-5">
                        <i className="far fa-file-alt fs-20 me-2"></i>Add Category
                    </Link>
                </li>
            </div>
            <div className="row">
